    ...
    targets.named<org.jetbrains.kotlin.gradle.targets.jvm.KotlinJvmTarget>("jvm") {
        ...
        compilations.create("benchmark") {
            ...
            compileTaskProvider.configure {
                ...
                // remains Java 21 and the scored forks are pinned to Java 21 below.
...
val jvmBenchmarkAllocationStats by tasks.registering(Exec::class) {
    ...
    doFirst {
        val java21 = project.extensions.getByType<JavaToolchainService>()
...
val jvmFlameChart by tasks.registering(JavaExec::class) {
    ...
    // Match the jvmToolchain (Java 21) used to compile the main classes
    javaLauncher.set(
